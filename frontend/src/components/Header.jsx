        ...
        <nav className="flex items-center gap-x-10">
          {menuItems.map((item, index) => (
            ...
            >
              {item.name}
              <span
                className={`absolute left-0 -bottom-1 w-full h-0.5 origin-center scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ${
                  isHome ? "bg-white" : "bg-red-600"
                }`}
              ></span>
            </Link>
          ))}
          ...
          {user === null ? (
            <>
              <Link
                ...
                className={`text-sm font-bold px-6 py-2 border rounded-full transition-all duration-300 ${
                  isHome
                    ? "text-white hover:bg-white hover:text-red-600 hover:border-white"
            ...
            <>  
              ...
              <span
                className={`text-sm font-bold max-w-[140px] truncate block ${
                  isHome ? "text-white" : "text-gray-800"
                }`}
                title={user.username}
              >
